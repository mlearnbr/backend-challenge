...
class ApiUserUpgrade implements ShouldQueue
{
    ...
    public function __construct(User $user)
    {
        ...
        $this->apiEndpoint = sprintf( '%s/integrator/%s/users/%s/upgrade', env('API_STAGING_URL'), env('API_SERVICE_ID'), $user->external_id );
    }
