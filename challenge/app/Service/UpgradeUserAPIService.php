...
class UpgradeUserAPIService implements UpgradeUserAPIInterface{

    public function handle(UpgradeUserDTO $dataDTO)
    {
        $url = env('QUALIFICA_BASE_URL', 'https://api.staging.mlearn.mobi/'). 'integrator/'.env('QUALIFICA_SERVICE', 'qualifica'). '/users/'.$dataDTO->id.'/upgrade';
