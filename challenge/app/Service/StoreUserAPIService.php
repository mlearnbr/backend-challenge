...
class StoreUserAPIService implements StoreUserAPIInterface{

    public function handle(StoreUserAPIDTO $dataDTO)
    {
        $url = env('QUALIFICA_BASE_URL', 'https://api.staging.mlearn.mobi/'). 'integrator/'.env('QUALIFICA_SERVICE', 'qualifica'). '/users';
